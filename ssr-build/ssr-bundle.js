...
module.exports = {"header":{"title":"Jerry Chong","subtitle":"Full Stack Engineer @ Accenture","background_color":"rgba(100, 100, 100, 0.8)","background_image":"kuala-lumpur.jpg","background_images":[{"width":2560,"filename":"kuala-lumpur-xlarge.jpg"},{"width":1920,"filename":"kuala-lumpur.jpg"},{"width":1600,"filename":"kuala-lumpur-large.jpg"},{"width":1280,"filename":"kuala-lumpur-medium.jpg"},{"width":960,"filename":"kuala-lumpur-small.jpg"},{"width":480,"filename":"kuala-lumpur-xsmall.jpg"}]},"profile":{"title":"Profile","background_color":"#FFF","about":{"title":"About me","description":"I'm a Full Stack Engineer speclized in building native mobile apps and web apps (Frontend, Backend & API) across AWS & GCP cloud platforms. During free time, I spent my time as Wikipedia Editor, Google Map Editor and Facebook Map Editor to impact our communities."},"bio":{"title":"Bio","list":[{"label":"Name","value":"Jerry Chong"},{"label":"City","value":"Kuala Lumpur"},{"label":"Country","value":"Malaysia"}]}},"experience":{"title":"Experience","background_color":"#41564E","list":[{"title":"Education","list":[{"location":"Universiti Tunku Abdul Rahman (UTAR)","time":{"from":"2012","to":"2016"},"title":"Bachelor of Engineering (Hons) Mechatronics Engineering","description":"Accredited by Malaysian Qualification Agency (MQA) and Board of Engineers Malaysia (BEM)"}]},{"title":"Career","list":[{"location":"Universiti Tunku Abdul Rahman (UTAR)","time":{"from":"Mar 2016","to":"Aug 2016"},"title":"Research Assistant","description":"Design and development of IoT rehabilitation system for UTAR's Undergraduate Research Scheme (URS) project named \"Development of Low Cost Upper Extremities Rehabilitation System with Interactive Feedback for Children with Movement Disorder\"."},{"location":"Wirecard","time":{"from":"Dec 2016","to":"Jan 2019"},"title":"Software Engineer, R&D Customer Implementation","description":"Design and development of EDC terminal payment applications."},{"location":"Explosoft","time":{"from":"Feb 2016","to":"Aug 2019"},"title":"Full Stack Engineer","description":"Design and development of Android & iOS native mobile apps, and backend (Node.js) web apps in GCP and Alibaba Cloud platforms."},{"location":"Accenture","time":{"from":"Aug 2019","to":"Present"},"title":"Digital Business Integration Analyst","description":"Design and development of frontend (Angular/React) and backend (Node.js/Java Spring Boot) web apps in AWS and GCP platforms."}]}]},"skills":{"title":"Skills","background_color":"#FFF","list":[{"label":"Node.js","value":4},{"label":"Android (Java & Kotlin)","value":4},{"label":"C","value":4},{"label":"iOS (Swift)","value":3},{"label":"SQL","value":3},{"label":"DevOps","value":3},{"label":"Amazon Web Services (AWS)","value":3},{"label":"Alibaba Cloud","value":3},{"label":"Google Cloud Platform (GCP)","value":3},{"label":"Terraform","value":3},{"label":"Vue","value":3},{"label":"Typescript","value":3},{"label":"Unit Testing","value":3},{"label":"C#","value":2},{"label":"Apigee","value":2},{"label":"Mulesoft","value":2},{"label":"React","value":2},{"label":"Angular","value":2}]},"contact":{"title":"Contact","background_color":"#5DC6DD","list":[{"label":"jerrychong25@gmail.com","link":"mailto:jerrychong25@gmail.com","icon_class":"envelope"},{"label":"LinkedIn","link":"https://www.linkedin.com/in/jerry-chong/","icon_class":"linkedin-square"},{"label":"GitHub","link":"https://github.com/jerrychong25","icon_class":"github"},{"label":"Stack Overflow","link":"https://stackoverflow.com/users/5918539/jerry-chong","icon_class":"stack-overflow"}]}}
...
function (_Component) {
  ...
  _createClass(OutboundLink, [{
    ...
    value: function render() {
      ...
      return preact_compat_es.createElement('a', props);
    }
  }]);
...
function core__objectWithoutProperties(source, excluded) {
  if (source == null) return {};var target = core__objectWithoutPropertiesLoose(source, excluded);var key, i;if (Object.getOwnPropertySymbols) {
    var sourceSymbolKeys = Object.getOwnPropertySymbols(source);for (i = 0; i < sourceSymbolKeys.length; i++) {
      key = sourceSymbolKeys[i];if (excluded.indexOf(key) >= 0) continue;if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue;target[key] = source[key];
    }
  }return target;
...
function core__objectWithoutPropertiesLoose(source, excluded) {
  if (source == null) return {};var target = {};var sourceKeys = Object.keys(source);var key, i;for (i = 0; i < sourceKeys.length; i++) {
    key = sourceKeys[i];if (excluded.indexOf(key) >= 0) continue;target[key] = source[key];
  }return target;
}
...
function core__objectSpread(target) {
  for (var i = 1; i < arguments.length; i++) {
    var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {
      core_ownKeys(source, true).forEach(function (key) {
        core__defineProperty(target, key, source[key]);
      });
    } else if (Object.getOwnPropertyDescriptors) {
      Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));
    } else {
...
function core__defineProperty(obj, key, value) {
  if (key in obj) {
    Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });
  } else {
    obj[key] = value;
...
function core__typeof(obj) {
  if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    core__typeof = function _typeof(obj) {
      return typeof obj;
    };
  } else {
    core__typeof = function _typeof(obj) {
...
function set(fieldsObject, trackerNames) {
  ...
  if (core__typeof(fieldsObject) !== 'object') {
...
function pageview(rawPath, trackerNames, title) {
  ...
  if (typeof ga === 'function') {
    _gaCommand(trackerNames, 'send', core__objectSpread({
      hitType: 'pageview',
      page: path
    }, extraFields));
...
function core_event() {
  var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      args = core__objectWithoutProperties(_ref2, ["category", "action", "label", "value", "nonInteraction", "transport"]);
...
var core_plugin = {
  ...
  require: function require(rawName, options, trackerName) {
    if (typeof ga === 'function') {
      ...
      if (options) {
        if (core__typeof(options) !== 'object') {
...
/* harmony default export */ var esm = (esm__objectSpread({}, core_namespaceObject, {
